export class PostDescriptions {
  public static MODEL: string = `A model that represents posts added by a user.`

  public static CONTENT: string = `Post content. The user can write anything they want in the post.`
